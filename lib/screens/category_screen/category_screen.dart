...
class _Category_screenState extends State<Category_screen> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var item in Applist.itemList) {
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: Image.asset(
                                  Applist.itemList[index]['item_image'],
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    Text(
                                      Applist.itemList[index]['item_name'],
                                      style: TextStyle(
                                          color: Appcolors.black_90,
                                          fontSize: 18.0,
                                          fontWeight: FontWeight.w700,
                                    ...
                                    Text(
                                        Applist.itemList[index]['item_price']
                                            .toString(),
                                        style: TextStyle(
                                            color: Appcolors.black_90,
                                            fontSize: 16.0,
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(
                                          filterData[index]['item_description'],
                                          style: TextStyle(
                                              color: Appcolors.black_45,
                                              fontSize: 12.0,
                                              fontWeight: FontWeight.w400,
