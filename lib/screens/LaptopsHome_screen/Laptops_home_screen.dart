...
import 'package:flutter_project/screens/LaptopsHome_screen/widgets/Lapptops_item_card.dart';
import 'package:flutter_project/screens/LaptopsHome_screen/widgets/Laptops_slider_card.dart';
import 'package:flutter_project/constant/app_list.dart';
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(
                                ...
                                fontSize: 14.0,
                                fontWeight: FontWeight.w500),
                            hintText: 'Search Laptops Or Accessories',
            ...
            Expanded(
              ...
              itemBuilder: (context, index) {
                return GrocceryItemCard(
                  itemImage: Applist.itemList[index]['item_image'],
                  itemPrice: Applist.itemList[index]['item_price'],
                  itemDes: Applist.itemList[index]['item_description'],
                  addtoCart: () => addToCart(Applist.itemList[index]),
                );
              },
              itemCount: Applist.itemList.length,
            ))
          ],
        ),
      ),
